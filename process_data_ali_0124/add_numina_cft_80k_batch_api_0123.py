...
batch_input_file = client.files.create(
    file=open("/cpfs/data/user/yubowang/CriticCoT/local_data/numina_batch_data_0123/batchinput-1.jsonl", "rb"),
    purpose="batch"
)
...
client.batches.create(
    ...
    metadata={
        "description": "numina cft job part 1"
    }
)

batch_input_file = client.files.create(
    file=open("/cpfs/data/user/yubowang/CriticCoT/local_data/numina_batch_data_0123/batchinput-2.jsonl", "rb"),
    purpose="batch"
)
...
client.batches.create(
    ...
    completion_window="24h",
    metadata={
        "description": "numina cft job part 2"
    }
)
