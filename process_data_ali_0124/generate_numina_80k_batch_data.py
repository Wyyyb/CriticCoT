...
def main():
    input_path = "/cpfs/data/user/yubowang/CriticCoT/LLaMA-Factory/data/numina_sft_80k_0119.json"
    output_path_1 = "/cpfs/data/user/yubowang/CriticCoT/local_data/numina_batch_data_0123/batchinput-1.jsonl"
    output_path_2 = "/cpfs/data/user/yubowang/CriticCoT/local_data/numina_batch_data_0123/batchinput-2.jsonl"
