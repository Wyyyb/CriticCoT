...
DATA_PATH="/data/yubowang/CriticCoT/dsr_scripts_0514/dsr_one-shot_train_data_0514_p3.jsonl"

OUTPUT_DIR="/data/yubowang/CriticCoT/ms-swift/output_models_dsr_0514_p3/"
