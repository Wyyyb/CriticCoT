...
summary_path="../math_eval_result_0114/ckpts_summary_0114_dense_p0_new.txt"
root_dir="/gpfs/public/research/xy/yubowang/CriticCoT/LLaMA-Factory/output_models_dense_0112"

find "$root_dir" -type d -name "qwen2.5-7B_correct-only_1231-0111" | while read -r model_dir; do
  echo $model_dir
