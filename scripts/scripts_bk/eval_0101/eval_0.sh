...
output_dir="../math_eval_result_new/eval_res_0101/ori_qwen2.5_7B/"
bash eval_math.sh $model_path $output_dir


model_path="/gpfs/public/research/xy/yubowang/models/Qwen2.5-Math-7B"
output_dir="../math_eval_result_new/eval_res_0101/ori_qwen2.5_math_7B/"
bash eval_math.sh $model_path $output_dir


model_path="/gpfs/public/research/xy/yubowang/models/deepseek-math-7b-base"
output_dir="../math_eval_result_new/eval_res_0101/ori_deepseek-math-7b-base/"
bash eval_math.sh $model_path $output_dir
