...
summary_path="../math_eval_result_0115_qwen_new/merged_critic_ckpts_summary_0115_dense_p2_new.txt"
root_dir="/gpfs/public/research/xy/yubowang/CriticCoT/LLaMA-Factory/output_models_0114"

find "$root_dir" -type d -name "qwen2.5-math-7B_merged_critic_0114" | while read -r model_dir; do
  echo $model_dir
