...
summary_path="${BASE_DIR}/summary_0116_p0.txt"
...
for temp in 0.3 0.6 0.9 0.1; do
    ...
    output_dir="${BASE_DIR}/qwen_eval_res_0116_multi_result/qwen2.5-math-7B_t2_critic_test_0114-checkpoint-80-t_${temp_str}/"
