...
summary_path="/gpfs/public/research/xy/yubowang/CriticCoT/Qwen2.5-Math-Eval/math_eval_result_0116_Mathstral/Mathstral_ckpts_summary_0116_dense_p0_new.txt"
