...
def main():
    input_file = "../local_data/deepmath_cft_data/deepmath_integrate_data_0428_add_critique.json"
    output_file = "../local_data/deepmath_cft_data/deepmath_integrate_data_0428_add_critique_new.json"
