...
cd /mnt/hwfile/opendatalab/yubo/CriticCoT/process_data_0421_pjlab
# 运行您的Python脚本，并将标准输出和标准错误重定向到指定文件
python -u qwen_32b_distill_gen_critique_0422_p2.py > qwen_32b_distill_gen_critique_0424_output_p2.txt 2>&1
# python -u qwen_32b_distill_gen_critique_0422.py
