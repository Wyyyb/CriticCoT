...
summary_path="/gpfs/public/research/xy/yubowang/CriticCoT/math_eval_result_qwen2.5-math-7B_numina_cft_80k_0119/summary.txt"
root_dir="/gpfs/public/research/xy/yubowang/CriticCoT/LLaMA-Factory/output_models_0119"

find "$root_dir" -type d -name "qwen2.5-math-7B_numina_cft_80k_0119" | while read -r model_dir; do
  echo $model_dir
