...
model_path="/map-vepfs/yubo/cft_models/bbeh_qwen25_math_7b_1-shot_cft_disambiguation_qa_ckpt30"
output_path="/map-vepfs/yubo/CriticCoT/eval_results_0530/bbeh_qwen25_math_7b_1-shot_cft_disambiguation_qa_ckpt30/"
