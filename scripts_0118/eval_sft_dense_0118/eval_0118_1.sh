...
summary_path="/gpfs/public/research/xy/yubowang/CriticCoT/math_eval_result_0118/numina_summary_0118_dense.txt"
root_dir="/gpfs/public/research/xy/yubowang/CriticCoT/LLaMA-Factory/output_models_0118"

find "$root_dir" -type d -name "qwen2.5-math-7B_numina_sample_80k_data_0118" | while read -r model_dir; do
  echo $model_dir
