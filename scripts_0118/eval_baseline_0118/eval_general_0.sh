...
model_names=("MAmmoTH-Critique-1" "Llama-3.1-8B-Instruct" "Llama-3.1-70B-Instruct" "NuminaMath-72B-CoT" "Qwen2.5-Math-72B-Instruct" "AceMath-Qwen-Math" "Eurus-2-7B-SFT")
