...
import glob
from sft_call_api_functions import *
...
if __name__ == "__main__":
    ...
    teacher_model_name = "gpt-4o-2024-11-20"
    INPUT_FILE = "../../local_data/one_shot_data_0514/dsr_shot_data_with_solution_0514.json"
    OUTPUT_FILE = f"../../local_data/one_shot_data_0516/dsr_shot_data_add_api_solution_{teacher_model_name}_0516.json"  # 结果输出文件路径
    NUM_PROCESSES = 2  # 进程数
