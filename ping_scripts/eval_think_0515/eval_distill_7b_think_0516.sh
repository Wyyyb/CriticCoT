...
for ckpt_num in "${checkpoint_numbers[@]}"; do
    summary_path="../eval_results_distill_7b_think_1-shot_0516/summary.txt"
    model_path="/data/yubo/CriticCoT/ms-swift/output_models_dsr_distill_7b_0516_1-shot_think//checkpoint-${ckpt_num}"
    output_path="../eval_results_distill_7b_think_1-shot_0516/ckpt_${ckpt_num}/"
