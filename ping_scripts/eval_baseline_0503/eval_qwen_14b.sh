...
summary_path="../baseline_eval_results_0503/Qwen3-8B/summary.txt"
model_path="/data/yubo/models/Qwen3-8B"
output_path="../baseline_eval_results_0503/Qwen3-8B/"
...
summary_path="../baseline_eval_results_0503/Qwen3-8B-Base/summary.txt"
model_path="/data/yubo/models/Qwen3-8B-Base"
output_path="../baseline_eval_results_0503/Qwen3-8B-Base/"
