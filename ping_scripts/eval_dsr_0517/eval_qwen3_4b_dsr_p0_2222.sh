...
for ckpt_num in "${checkpoint_numbers[@]}"; do
    summary_path="../eval_results_dsr_0517_p0/summary.txt"
    model_path="/data/yubo/CriticCoT/ms-swift/output_models_qwen3_4b_base_dsr_0516_p0/v0-20250517-041751/checkpoint-${ckpt_num}"
    output_path="../eval_results_dsr_0517_p0/dsr_p0_ckpt_${ckpt_num}/"
