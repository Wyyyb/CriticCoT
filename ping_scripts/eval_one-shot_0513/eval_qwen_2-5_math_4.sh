...
for ckpt_num in "${checkpoint_numbers[@]}"; do
    summary_path="../eval_results_0514_0/summary.txt"
    model_path="/data/yubo/CriticCoT/ms-swift/output_models_0514_one_shot_balance/v0-20250514-055148/checkpoint-${ckpt_num}"
    output_path="../eval_results_0514_0/balance_one-shot_exp_ckpt_${ckpt_num}/"
