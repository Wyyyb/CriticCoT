...
for ckpt_num in "${checkpoint_numbers[@]}"; do
    summary_path="../eval_results_deepseek_dsr_0516_p0/summary.txt"
    model_path="/data/yubo/CriticCoT/ms-swift/output_models_dsr_dpsk_math_7b_0516_p0/v0-20250516-204413/checkpoint-${ckpt_num}"
    output_path="../eval_results_deepseek_dsr_0516_p0/dpsk_dsr_p0_ckpt_${ckpt_num}/"
