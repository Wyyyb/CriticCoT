...
# 设置要处理的检查点数字列表
checkpoint_numbers=(20 40 60 80 100 120 140)
...
for ckpt_num in "${checkpoint_numbers[@]}"; do
    summary_path="../eval_results_sft_dsr_0516_p0/summary.txt"
    model_path="/data/yubo/CriticCoT/ms-swift/output_models_qwen2-5_math_7b_full_dsr_sft_0516/v0-20250516-230832/checkpoint-${ckpt_num}"
    output_path="../eval_results_sft_dsr_0516_p0/dsr_p0_ckpt_${ckpt_num}/"
