...
for ckpt_num in "${checkpoint_numbers[@]}"; do
    summary_path="../eval_results_llama_dsr_0516_p0/summary.txt"
    model_path="/data/yubo/CriticCoT/ms-swift/output_models_dsr_llama-3b_ins_0516_p0/v0-20250516-192104/checkpoint-${ckpt_num}"
    output_path="../eval_results_llama_dsr_0516_p0/llama_dsr_p0_ckpt_${ckpt_num}/"
    ...
    bash evaluate_llama.sh $model_path $output_path $summary_path
