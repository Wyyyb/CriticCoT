...
checkpoint_numbers=(24 32 40 48 56 64 72 80 88 96 104 112)
...
for ckpt_num in "${checkpoint_numbers[@]}"; do
    summary_path="../eval_results_dsr_0514_p0_2_3/summary.txt"
    model_path="/data/yubo/CriticCoT/ms-swift/output_models_dsr_0514_p0_2_3/v0-20250515-174516/checkpoint-${ckpt_num}"
    output_path="../eval_results_dsr_0514_p0_2_3/dsr_p0_ckpt_${ckpt_num}/"
