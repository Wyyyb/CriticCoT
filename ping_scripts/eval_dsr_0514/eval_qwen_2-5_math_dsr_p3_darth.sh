...
for ckpt_num in "${checkpoint_numbers[@]}"; do
    summary_path="../eval_results_dsr_0514_p3/summary.txt"
    model_path="/data/yubowang/CriticCoT/ms-swift/output_models_dsr_0514_p3/v2-20250515-150920/checkpoint-${ckpt_num}"
    output_path="../eval_results_dsr_0514_p3/dsr_p3_ckpt_${ckpt_num}/"
