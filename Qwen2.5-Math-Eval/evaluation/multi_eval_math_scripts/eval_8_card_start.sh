...
bash eval_sinlge_card_5.sh $summary_path $model_dir&
bash eval_sinlge_card_6.sh $summary_path $model_dir&
bash eval_sinlge_card_7.sh $summary_path $model_dir&
bash eval_sinlge_card_8.sh $summary_path $model_dir