...
DATA_PATH="/data/yubo/CriticCoT/local_data/sft_data_0516/dsr_full_40k_sft_data.json"

OUTPUT_DIR="/data/yubo/CriticCoT/ms-swift/output_models_qwen2-5_math_7b_full_dsr_sft_0516/"
