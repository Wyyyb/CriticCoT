...
class RayPPOTrainer:
    ...
    def __init__(
        ...
        self.save_dir = os.path.join(
            os.environ.get('SAMPLE_LOG_DIR', '/data/minimax-dialogue/users/xiancai/verl/sample_log'),
            os.environ.get('JOB_ID', 'debug'))
    ...
    def _validate(self):
        ...
        for test_data in self.val_dataloader:
            ...
            if "raw_dataset" in test_batch.non_tensor_batch:
                non_tensor_batch_keys_to_pop.append("raw_dataset")
            ...
            print(len(test_output_gen_batch_padded))
            # unpad
    ...
    # def init_r2e_env(self, batch: DataProto, n: int):
    #     """
    ...
    #         futures = [executor.submit(self._init_r2e_env_single, index, ds) for index, ds in enumerate(all_ds)]
    ...
    # def _init_r2e_env_single(self, index: int, dumped_dataset: str):
    #     try:
        ...
        for epoch in range(self.config.trainer.total_epochs):
            for batch_dict in self.train_dataloader:
                ...
                if "raw_prompt" in batch.non_tensor_batch:
                    non_tensor_batch_keys_to_pop.append("raw_prompt")
                if "raw_dataset" in batch.non_tensor_batch:
                    non_tensor_batch_keys_to_pop.append("raw_dataset")
                ...
                with marked_timer("step", timing_raw):
                    ...
                    save_path = os.path.join(self.save_dir, f'batch_{self.global_steps:04d}.pkl')
