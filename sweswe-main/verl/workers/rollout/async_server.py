...
from verl.workers.rollout.chat_scheduler import ChatCompletionScheduler, R2EChatCompletionScheduler
...
class AsyncLLMServerManager:
        ...
        while len(unready_dp_ranks) > 0:
            ...
            for rollout_dp_rank, server in servers.items():
                try:
                    ...
                    # append address to no_proxy to avoid proxy
                    os.environ["no_proxy"] = f"{address},{os.environ.get('no_proxy', '')}"
    ...
    def _init_chat_scheduler(self):
        ...
        try:
            self.chat_scheduler = R2EChatCompletionScheduler(
