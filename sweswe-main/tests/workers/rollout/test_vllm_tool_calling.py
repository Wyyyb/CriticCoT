...
class ToolChatCompletionScheduler(NaiveChatCompletionScheduler):
    ...
    async def generate_sequences(self, batch: DataProto, **sampling_params) -> DataProto:
        ...
        async def callback(completions: ChatCompletion, info: Dict[str, Any], exception: Exception):
            ...
            print(f"[id={completions.id},turn={turn}]\nRole:\n{role}\nContent:\n{content}")
...
def test_vllm_tool_calling():
    ...
    config.actor_rollout_ref.model.path = "/data/minimax-dialogue/users/xiancai/hf_models/Qwen2.5-7B-Instruct"
    ...
    # Build dataset
    dataset = load_dataset("/data/minimax-dialogue/users/xiancai/hf_datasets/Maxwell-Jia/AIME_2024", split="train")
