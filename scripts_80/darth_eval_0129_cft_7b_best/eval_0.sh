...
summary_path="/data/yubowang/CriticCoT/0129_eval_results_CFT-Webinstruct-0121-ckpt-t_0_full/summary.txt"
output_dir="/data/yubowang/CriticCoT/0129_eval_results_CFT-Webinstruct-0121-ckpt-t_0_full"
checkpoint_dir="/data/yubowang/models/CFT-Webinstruct-0121-ckpt"

#bash eval_compe.sh "$checkpoint_dir" "$output_dir" "$summary_path"
bash eval_full_0129.sh "$checkpoint_dir" "$output_dir" "$summary_path"
