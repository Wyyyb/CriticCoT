...
summary_path="/data/yubo/CriticCoT/0129_eval_results_CFT-Webinstruct-0121-ckpt-t_0/summary.txt"
output_dir="/data/yubo/CriticCoT/0129_eval_results_CFT-Webinstruct-0121-ckpt-t_0"
checkpoint_dir="/data/yubo/models/CFT-Webinstruct-0121-ckpt"

#bash eval_compe.sh "$checkpoint_dir" "$output_dir" "$summary_path"
bash eval_minerva_temp.sh "$checkpoint_dir" "$output_dir" "$summary_path" 0.0
