...
summary_path="/data/yubo/CriticCoT/0129_eval_results_qwen2.5-7b-math-cft-gpt-4o-0128-t_0_3/summary.txt"
output_dir="/data/yubo/CriticCoT/0129_eval_results_qwen2.5-7b-math-cft-gpt-4o-0128-t_0_3"
checkpoint_dir="/data/yubo/models/qwen2.5-7b-math-cft-gpt-4o-0128"

#bash eval_compe.sh "$checkpoint_dir" "$output_dir" "$summary_path"
bash eval_full.sh "$checkpoint_dir" "$output_dir" "$summary_path" 0.3
