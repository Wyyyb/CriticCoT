...
cd /mnt/hwfile/opendatalab/yubo/CriticCoT/process_data_0424_pjlab
# 运行您的Python脚本，并将标准输出和标准错误重定向到指定文件
python -u qwen_32b_distill_gen_critique_0428.py > qwen_32b_distill_gen_critique_0428_output_p1.txt 2>&1
