...
def format_critic_data(question, answer, gpt4o_answer):
    question = "Please analyze and evaluate the following solution step by step:\n\nQuestion:\n" + question
    student_solution = "\nStudent's Solution:\n" + answer
    critique = "Critique:\n" + gpt4o_answer
...
def main():
    ...
    os.makedirs("../local_data/critic_training_data_1231", exist_ok=True)
    with open("../local_data/critic_training_data_1231/CriticCoT_correct_only_data_1231.json", "w") as fo:
        fo.write(json.dumps(correct_only_training_data, indent=2))
    print("length of correct_only data", len(correct_only_training_data))
    mode = "critic"
    ...
    with open("../local_data/critic_training_data_1231/CriticCoT_critic_data_1231.json", "w") as fo:
        fo.write(json.dumps(critic_training_data, indent=2))
    print("length of critic data", len(critic_training_data))
    with open("../local_data/critic_training_data_1231/CriticCoT_critic_add_50k_correct_data_1231.json", "w") as fo:
