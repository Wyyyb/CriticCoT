...
batch_input_file = client.files.create(
    file=open("/cpfs/data/user/yubowang/CriticCoT/local_data/webinstruct_mini_batch_data/batchinput-1.jsonl", "rb"),
    purpose="batch"
)
...
client.batches.create(
    ...
    metadata={
        "description": "webinstruct_minia cft job part 1"
    }
)

batch_input_file = client.files.create(
    file=open("/cpfs/data/user/yubowang/CriticCoT/local_data/webinstruct_mini_batch_data/batchinput-2.jsonl", "rb"),
    purpose="batch"
)
...
client.batches.create(
    ...
    completion_window="24h",
    metadata={
        "description": "webinstruct_mini cft job part 2"
    }
)
