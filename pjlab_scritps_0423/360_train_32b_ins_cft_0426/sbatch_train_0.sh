...
FORCE_TORCHRUN=1 llamafactory-cli train ../pjlab_scritps_0423/360_train_32b_ins_cft_0426/qwen2.5-32b_ins_0424_0.yaml > 360_train_32b_instruct_cft_0426_output.txt 2>&1
