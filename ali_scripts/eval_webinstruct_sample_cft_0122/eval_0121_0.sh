...
summary_path="/cpfs/data/user/yubowang/CriticCoT/math_eval_result_qwen2.5-math-7B_webinstruct_cft_80k_0122_p0/summary.txt"
root_dir="/cpfs/data/user/yubowang/CriticCoT/LLaMA-Factory/output_models_0121"

find "$root_dir" -type d -name "qwen2.5-math-7B_webinstruct_cft_80k_0122_p0" | while read -r model_dir; do
  echo $model_dir
