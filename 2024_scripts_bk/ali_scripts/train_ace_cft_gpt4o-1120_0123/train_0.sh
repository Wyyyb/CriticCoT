...
FORCE_TORCHRUN=1 llamafactory-cli train ../ali_scripts/train_ace_cft_gpt4o-1120_0123/qwen2.5-math-7B_ace_cft_80k_0123.yaml

bash ../ali_scripts/train_ace_cft_gpt4o-1120_0123/eval_0123_0.sh
