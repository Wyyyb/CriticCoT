...
summary_path="/cpfs/data/user/yubowang/CriticCoT/math_eval_result_qwen2.5-math-7B_ace_80k_critique_ace_0120/summary.txt"
root_dir="/cpfs/data/user/yubowang/CriticCoT/LLaMA-Factory/output_models_0120"

find "$root_dir" -type d -name "qwen2.5-math-7B_ace_80k_critique_ace_0120" | while read -r model_dir; do
  echo $model_dir
