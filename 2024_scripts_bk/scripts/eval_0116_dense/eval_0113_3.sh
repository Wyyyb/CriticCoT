...
summary_path="/gpfs/public/research/xy/yubowang/CriticCoT/Qwen2.5-Math-Eval/math_eval_result_0116_Mathstral/Mathstral_ckpts_summary_0116_dense_p1_new.txt"
...
find "$root_dir" -type d -name "CriticCoT_critic_data_0114" | while read -r model_dir; do
  echo $model_dir
  bash mathtral_eval_dir_models_math.sh $model_dir $summary_path
done
