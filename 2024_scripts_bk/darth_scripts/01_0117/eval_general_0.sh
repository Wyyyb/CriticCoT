...
for model in "${model_names[@]}";do
  ...
  output_dir="/gpfs/public/research/xy/yubowang/CriticCoT/eval_results_darth/general_results/${model}"
  summary_dir="/gpfs/public/research/xy/yubowang/CriticCoT/eval_results_darth/general_results/${model}_general_summary.txt"
  mkdir -p $output_dir
