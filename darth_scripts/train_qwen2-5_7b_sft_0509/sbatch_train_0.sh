...
FORCE_TORCHRUN=1 llamafactory-cli train ../pjlab_scripts_0428/360_train_32b_ins_corr_28k_0430/qwen2.5-32b_ins_0427_0.yaml > 360_train_32b_ins_corr_28k_0430_output.txt 2>&1
