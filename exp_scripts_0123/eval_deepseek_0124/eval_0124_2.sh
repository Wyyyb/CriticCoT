...
summary_path="/cpfs/data/user/yubowang/CriticCoT/math_eval_result_deepseek-math-7b-base_webinstruct_cft_80k_0119_ori_eval_5shot/summary.txt"
root_dir="/cpfs/data/user/yubowang/CriticCoT/LLaMA-Factory/output_models_0124"

find "$root_dir" -type d -name "deepseek-math-7b-base_webinstruct_cft_80k_0119" | while read -r model_dir; do
  echo $model_dir
