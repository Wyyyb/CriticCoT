...
summary_path="/cpfs/data/user/yubowang/CriticCoT/math_eval_result_qwen2.5-math-7B_webinstruct_cft_80k_0121_p3_t0/summary.txt"
...
find "$root_dir" -type d -name "qwen2.5-math-7B_webinstruct_cft_80k_0121_p3" | while read -r model_dir; do
  echo $model_dir
  bash eval_dir_models_math_3.sh $model_dir $summary_path
done
