...
MODEL_PATH="/data/yubo/models/Llama-3.2-3B-Instruct"

DATA_PATH="/data/yubo/CriticCoT/dsr_scripts_0516/dsr_one-shot_train_data_0514_p0.jsonl"

OUTPUT_DIR="/data/yubo/CriticCoT/ms-swift/output_models_dsr_llama-3b_ins_0516_p0/"
