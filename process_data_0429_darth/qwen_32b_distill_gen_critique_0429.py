...
def get_process_data(output_data):
    process_data = []
    sta_count = {"Qwen3-32B_critique": 0,
                 "Qwen3-32B_critique_valid": 0,
    ...
    for k, v in output_data.items():
        if "qwen-2.5-32b_answer" in v and v.get("qwen-2.5-32b_answer_valid") is True:
            ...
            if "Qwen3-32B_critique" in v:
                sta_count["Qwen3-32B_critique"] += 1
            if "Qwen3-32B_critique" in v and \
                    v.get("Qwen3-32B_critique_valid", False) is True:
                sta_count["Qwen3-32B_critique_valid"] += 1
                continue
    ...
    while len(process_data) > 500:
        ...
        for batch_idx in range(total_batches):
            ...
            for i, output in enumerate(batch_output):
                ...
                output_data[question]["Qwen3-32B_critique"] = output
                ...
                output_data[question]["Qwen3-32B_critique_answer"] = critique_answer
                output_data[question]["Qwen3-32B_critique_conclusion"] = critique_conclusion
                output_data[question]["Qwen3-32B_critique_valid"] = critique_valid
                if critique_valid:
